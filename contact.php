...
<section style="min-height:450px;">
    <div class="container" style="color:black;">
        ...
        <div class="row" style="color:black">
            <div class="col-md-6 mt-5 mb-5 pl-5" style="border-radius:30px;background-color:gold">
                <h2 class="mt-5" >Contact Information</h2>
                <p class="mt-1" >
                    Our team will get back to you with in 24hours. 
                </p>

                <p class="mt-5"><i class="fa fa-phone  mt-3"></i>&nbsp; +91 300 - 1234567</p>
                ...
                <div class="mb-5">
                        <a href="#" class="mt-5" style="color:black;"><i class="fa fa-facebook-square fa-2x  mt-3"></i></a>
                        <a href="#" class="mt-5 ml-3" style="color:black;"><i class="fa fa-twitter-square fa-2x  mt-3"></i></a>
                        <a href="#" class="mt-5 ml-3" style="color:black;"><i class="fa fa-instagram fa-2x  mt-3"></i></a>
                        <a href="#" class="mt-5 ml-3" style="color:black;"><i class="fa fa-linkedin-square fa-2x  mt-3"></i></a>
                </div>
            </div>
            <div class="col-md-6">
                <form method="post">
                    <div class="container" style="color:black;">
                        ...
                        <button type="submit" name="btn_submit" class="btn" style="background-color:gold;color:black;">Send Message</button>
                    </div>
                </form>
            </div>
        </div>
