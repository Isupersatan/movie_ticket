...
<body>
  ...
  <nav class="navbar navbar-expand-md navbar-black" style="background-color:gold">
  ...
  <div class="modal fade" id="modelId" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
      <div class="modal-dialog" role="document">
          <div class="modal-content">
              <div class="modal-header" style="background-color:gold;color:black;">
            ...
            <form method="post">
                <div class="container" style="color:black;">
                    ...
                    <button type="submit" class="btn" name="btn_reg" style="background-color:gold;color:black;">Rgister</button>
                    <hr>
                </div>
                ...
                <form method="post">
                    <div class="container" style="color:black;">
                     ...
                     <hr>
                        ...
                        <button type="submit" name="btn_login" class="btn" style="background-color:gold;color:black;">Login</button>
                    </div>
                </form>
              </div>
              <!-- <div class="modal-footer">
