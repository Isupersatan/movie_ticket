...
<section class="mt-5">
    <h3 class="text-center"  style="color:black;">Book Your Ticket Now</h3>
   <div class="container">
       <div class="row">
           <div class="col-md-7">
                <div id="seat-map" id="seatCharts">
                    <h3 class="text-center mt-5"  style="color:black;">Select Seat</h3>
                    <hr>
                    <label class="text-center" style="width:100%;background-color:gold;color:black;padding:2%"> 
                        SCREEN
                    </label>
                ...
                <!--<h6 class="mt-5"  style="color:black;">Cinema Name</h6>
                <p class="mt-1" id="cinema_name"></p>


                <h6 class="mt-3"  style="color:black;">Movie Show (Date and Timing)</h6>
                <p class="mt-1" id="show_date_time"></p>

                <h6 class="mt-3"  style="color:black;">Ticket Price</h6>
                <p class="mt-1" id="price"></p>

                <h6 class="mt-3"  style="color:black;">Total Ticket Price</h6>
           ...
           <div class="col-md-5">
                <form method="post" class="mt-5">
                    ...
                    <hr>
                        ...
                        <button type="submit" name="btn_booking" class="btn" style="background-color:gold;color:black;">Confirm Booking</button>
                        <hr>
                    </div>
